...
while True:
    ...
    cv2.rectangle(img,(80,150) , (80+277, 150 + 790), (255, 0, 0), cv2.FILLED)
    cv2.circle(img, (215, 300), 100, (255,255,255), -1)
    draw_text(img, "Left: "+str(white), center_x-850, center_y-450,color = (0, 255, 0), thickness = 8, size = 2)
    cv2.circle(img, (215, 700), 110, (0,0,0), -1)
    draw_text(img, "Left: "+str(black), center_x-850, center_y-50,color = (0, 255, 0), thickness = 8, size = 2)
