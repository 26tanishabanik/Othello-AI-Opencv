...
while True:
    ...
    if gameOver:
        ...
        if EvalBoard(board, '1') > EvalBoard(board, '2'):
            cv2.rectangle(img,(center_x+1300,center_y-900) , (center_x+1300 + 700, center_y-900 + 500), (255, 0, 0), cv2.FILLED)
            ...
            cv2.rectangle(img,(center_x+1300,center_y-900) , (center_x+1300 + 700, center_y-900 + 500), (255, 0, 0), cv2.FILLED)
            draw_text(img, "AI WINS!!", center_x+1300, center_y-700,color = (0,255,255), thickness = 10, size= 3)
            draw_text(img, str(EvalBoard(board, '2')) , center_x+1300, center_y-500,color = (0,255,255), thickness = 10, size = 4)
        else:
            cv2.rectangle(img,(center_x+1300,center_y-900) , (center_x+1300 + 700, center_y-900 + 500), (255, 0, 0), cv2.FILLED)
            draw_text(img, "DRAW", center_x+1300, center_y-700,color = (0,255,255), thickness = 12, size= 3)
            draw_text(img, "Your score: "+str(EvalBoard(board, '1')) , center_x+1300, center_y-600,color = (0,255,255), thickness = 12, size = 4)
            draw_text(img, "AI's score: "+str(EvalBoard(board, '2')) , center_x+1300, center_y-500,color = (0,255,255), thickness = 12, size = 4)

    if tip:
        cv2.rectangle(img,(center_x+1300,center_y-900) , (center_x+1300 + 700, center_y-900 + 500), (255, 0, 0), cv2.FILLED)
        draw_text(img, "Red Blink means", center_x+1400, center_y-800,color = (0, 255, 255), thickness = 10, size = 2)
        draw_text(img, "invalid move", center_x+1400, center_y-700,color = (0, 255, 255), thickness = 10, size = 2)
    ...
    cv2.rectangle(img,(80,150) , (80+280, 150 + 790), (255, 0, 0), cv2.FILLED)
    cv2.circle(img, (215, 300), 100, (255,255,255), -1)
    draw_text(img, "Count:"+str(white), center_x-850, center_y-450,color = (0, 255, 0), thickness = 4, size = 2)
    cv2.circle(img, (215, 700), 110, (0,0,0), -1)
    draw_text(img, "Count:"+str(black), center_x-850, center_y-50,color = (0, 255, 0), thickness = 4, size = 2)
